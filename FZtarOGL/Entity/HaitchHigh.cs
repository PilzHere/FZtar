...
{
    public class HaitchHigh : Entity
    {
        ...
        // middle
        private const float Boxf03MinX = -3f, Boxf03MinY = 0f, Boxf03MinZ = -1.5f;
        ...
        public HaitchHigh(Screen.Screen screen, AssetManager assMan, Vector3 position, Vector3 modelColor)
        {
            _screen = screen;
            _assMan = assMan;
            _modelColor = modelColor;

            _model = _assMan.Heich03Model;
