...
{
    public class SpaceJunk02 : Entity
    {
        ...
        public SpaceJunk02(Screen.Screen screen, AssetManager assMan, Vector3 position, Vector3 direction)
        {
            _screen = screen;
            _assMan = assMan;
            _direction = direction;

            _modelSpaceJunk = _assMan.SpaceJunk02Model;
