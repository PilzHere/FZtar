...
namespace FZtarOGL.Camera
{
    public class PerspectiveCamera
    {
        ...
        public float fieldOfViewDegrees = 45f; // was 80
        ...
        /// </summary>
        public PerspectiveCamera(GraphicsDevice gfxDevice, GameWindow window)
        {
        ...
        public Vector3 TargetPositionToLookAt
        {
            set
            {
                camerasWorld = Matrix.CreateWorld(camerasWorld.Translation,
                    Vector3.Normalize(value - camerasWorld.Translation), up);
                // since we know here that a change has occured to the cameras world orientations we can update the view matrix.
                ReCreateWorldAndView();
            }
        }
        ...
        public Matrix LookAtTheTargetMatrix
        {
            ...
            {
                camerasWorld = Matrix.CreateWorld(camerasWorld.Translation,
                    Vector3.Normalize(value.Translation - camerasWorld.Translation), up);
                // since we know here that a change has occured to the cameras world orientations we can update the view matrix.
                ReCreateWorldAndView();
            }
        }
        ...
        public Matrix World
        {
            ...
            {
                camerasWorld = value;
                viewMatrix = Matrix.CreateLookAt(camerasWorld.Translation,
                    camerasWorld.Forward + camerasWorld.Translation, camerasWorld.Up);
            }
        }
        ...
        private void ReCreateWorldAndView()
        {
            ...
            viewMatrix = Matrix.CreateLookAt(camerasWorld.Translation, camerasWorld.Forward + camerasWorld.Translation,
                camerasWorld.Up);
        }
        ...
        {
            projectionMatrix = Matrix.CreatePerspectiveFieldOfView(fovInDegrees * (float)((3.14159265358f) / 180f),
                gd.Viewport.Width / gd.Viewport.Height, .05f, 1000f);
        }
        ...
        public void ReCreateThePerspectiveProjectionMatrix(float fieldOfViewInDegrees, float nearPlane, float farPlane)
        {
            ...
            projectionMatrix =
                Matrix.CreatePerspectiveFieldOfView(this.fieldOfViewDegrees, aspectRatio, nearClipPlane, farClipPlane);
        }
        ...
        public void Update(GameTime gameTime)
        {
            ...
            //Console.WriteLine("lookatPos: " + TargetPositionToLookAt);
        }
        ...
        public void RotateRollClockwise(GameTime gameTime, float rotationSpeed)
        {
            var radians = rotationSpeed * (float)gameTime.ElapsedGameTime.TotalSeconds;
        ...
        public void RotateRollCounterClockwise(GameTime gameTime, float rotationSpeed)
        {
            var radians = -rotationSpeed * (float)gameTime.ElapsedGameTime.TotalSeconds;
            var pos = camerasWorld.Translation;
            camerasWorld *= Matrix.CreateFromAxisAngle(camerasWorld.Forward, MathHelper.ToRadians(radians));
